...
```
# Ghost-Tree (https://github.com/JTFouquier/ghost-tree.git) is neat, becuase it allows us to use fungal 
# ITS in phylogenetic analyses (which is normally impossible since it's too variable). It accomplishes
